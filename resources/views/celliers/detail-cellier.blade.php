                    ...
                    @forelse($bouteilles as $bouteille)
                        ...
                        <div class="col-md-3 card mb-1 mr-1" style="width: 18rem;">
                            ...
                            <div class="card-body text-carte">
                                ...
                                <!-- <p>Quantité : <input  @if(isset($searchQuery)) id="{{ $bouteille->id }}" @else id="{{ $bouteille->pivot->id }}" @endif  @if(isset($searchQuery)) name="{{ $bouteille->id }}" @else name="{{ $bouteille->pivot->id }}" @endif  type="number" min="1" @if(isset($searchQuery)) value="{{ $bouteille->quantite }}" @else   value="{{ $bouteille->pivot->quantite }}" @endif oninput="validNumberInput(this)" onblur="validateAndCorrect(this)" /></p>
